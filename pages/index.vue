<template>
  <div>
    <div class="navbar">
      <div class="navbar__banner">Felece Turizm</div>
    </div>
    <div class="hero">
...
.hero {
  ...
  &__brand {
    ...
    font-family: 'Oswald', serif;
    font-size: 7em;
    text-shadow: 5px 5px 10px #014983;
  }
  ...
  &__desc {
    ...
    font-size: 40px;
    margin-bottom: 1em;
    text-shadow: 5px 5px 10px #006100;
  }
  ...
  &__buttons {
    ...
    &__button {
      ...
      transition: transform 250ms ease-in-out,
        background-color 250ms ease-in-out, opacity 250ms linear;
