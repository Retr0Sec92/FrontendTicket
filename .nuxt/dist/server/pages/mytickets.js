...
module.exports.__inject__ = function (context) {
  add("e7e387a8", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_mytickets_vue_vue_type_style_index_0_id_375a3667_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(213);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_mytickets_vue_vue_type_style_index_0_id_375a3667_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_mytickets_vue_vue_type_style_index_0_id_375a3667_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_mytickets_vue_vue_type_style_index_0_id_375a3667_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_mytickets_vue_vue_type_style_index_0_id_375a3667_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
exports.push([module.i, ".hero[data-v-375a3667]{margin:0 auto;text-align:center;height:100%;padding:17em 0;background:radial-gradient(#fff 0,#fff 40%,#d8d8d8 70%,#8d8d8d 100%);background-size:cover;background-repeat:no-repeat;background-blend-mode:multiply;background-attachment:fixed}.hero__brand[data-v-375a3667]{color:#014983;font-family:\"Oswald\",serif;font-size:7em}.hero__brand[data-v-375a3667],.hero__desc[data-v-375a3667]{text-shadow:5px 5px 10px #585858}.hero__desc[data-v-375a3667]{color:#006100;font-family:\"Oswald\",cursive;font-size:40px;margin-bottom:1em}", ""]);
// Exports
module.exports = exports;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/mytickets.vue?vue&type=template&id=375a3667&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('v-dialog',{attrs:{"width":"1000px"},on:{"keydown":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"esc",27,$event.key,["Esc","Escape"])){ return null; }_vm.destDialog = !_vm.destDialog}},model:{value:(_vm.destDialog),callback:function ($$v) {_vm.destDialog=$$v},expression:"destDialog"}},[_c('v-card',[_c('v-toolbar',{attrs:{"dark":"","color":"primary"}},[_c('v-toolbar-title',[_vm._v("Güzergah Bilgileri")])],1),_vm._v(" "),_c('v-card-text',[_c('v-data-table',{staticClass:"elevation-1 mt-5",attrs:{"headers":_vm.headersDest,"items":_vm.destination_list,"light":"","item-key":"id","items-per-page":5,"footer-props":{
          ...
          var item = ref.item;
return [_vm._v("\n            "+_vm._s(_vm.formatStations(item.stations))+"\n          ")]}},{key:"no-data",fn:function(){return [_c('v-alert',{attrs:{"value":true,"color":"error"}},[_vm._v("\n              Güzergah Bulunmamaktadır !\n            ")])]},proxy:true}],null,true)})],1)],1)],1),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"width":"1000px"},on:{"keydown":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"esc",27,$event.key,["Esc","Escape"])){ return null; }_vm.busDialog = !_vm.busDialog}},model:{value:(_vm.busDialog),callback:function ($$v) {_vm.busDialog=$$v},expression:"busDialog"}},[_c('v-card',[_c('v-toolbar',{attrs:{"dark":"","color":"primary"}},[_c('v-toolbar-title',[_vm._v("Araç Bilgileri")])],1),_vm._v(" "),_c('v-card-text',[_c('v-data-table',{staticClass:"elevation-1 mt-5",attrs:{"headers":_vm.headersBus,"items":_vm.bus_list,"light":"","item-key":"id","items-per-page":10,"footer-props":{
            'items-per-page-text': 'Sayfa Başına Araç',
          }},scopedSlots:_vm._u([{key:"item.arrival",fn:function(ref){
          var item = ref.item;
return [_vm._v("\n            "+_vm._s(_vm.formatDate(item.arrival))+"\n          ")]}},{key:"item.freeSpace",fn:function(ref){
          var item = ref.item;
...
return [_c('v-btn',{attrs:{"color":"warning"},on:{"click":function($event){return _vm.showDestination(item.destinationid)}}},[_vm._v("Güzergah Bilgileri")])]}},{key:"item.departure",fn:function(ref){
          var item = ref.item;
return [_vm._v("\n            "+_vm._s(_vm.formatDate(item.departure))+"\n          ")]}},{key:"no-data",fn:function(){return [_c('v-alert',{attrs:{"value":true,"color":"error"}},[_vm._v("\n              Araç Bulunmamaktadır !\n            ")])]},proxy:true}],null,true)})],1)],1)],1),_vm._ssrNode(" "),_c('v-toolbar',{attrs:{"color":"primary","dark":""}},[_c('v-toolbar-title',[_vm._v("Biletlerim")])],1),_vm._ssrNode(" "),_c('v-container',[_c('v-data-table',{staticClass:"elevation-1 mt-5",attrs:{"headers":_vm.headers,"items":_vm.ticket_list,"light":"","item-key":"id","items-per-page":15,"footer-props":{
        'items-per-page-text': 'Sayfa Başına Kullanıcı',
      }},scopedSlots:_vm._u([{key:"item.bus",fn:function(ref){
      var item = ref.item;
return [_c('v-btn',{attrs:{"color":"success"},on:{"click":function($event){return _vm.showBus(item.busid)}}},[_vm._v("Araç Bilgilerini Görüntüle")])]}},{key:"item.ticketStatus",fn:function(ref){
      var item = ref.item;
return [_vm._v("\n        "+_vm._s(_vm.formatTicket(item.ticketStatus))+"\n      ")]}},{key:"item.postpone",fn:function(ref){
      var item = ref.item;
return [_c('v-icon',{attrs:{"right":""},on:{"click":function($event){return _vm.postpone(item.id)}}},[_vm._v(" mdi-alarm ")])]}},{key:"item.cancel",fn:function(ref){
      var item = ref.item;
return [_c('v-icon',{attrs:{"right":""},on:{"click":function($event){return _vm.cancel(item.id)}}},[_vm._v(" mdi-cancel ")])]}},{key:"no-data",fn:function(){return [_c('v-alert',{attrs:{"value":true,"color":"error"}},[_vm._v("\n          Bilet Bulunmamaktadır !\n        ")])]},proxy:true}],null,true)})],1)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/mytickets.vue?vue&type=template&id=375a3667&scoped=true&

// EXTERNAL MODULE: external "vuex"
var external_vuex_ = __webpack_require__(10);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/mytickets.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var myticketsvue_type_script_lang_js_ = ({
  data() {
    return {
      headersDest: [{
  ...
  methods: { ...Object(external_vuex_["mapActions"])({
    ...
    formatBus(item) {
      return 'Kalkış Durağı ve Saati : ' + this.formatDate(item.departure) + ' - ' + item.destination[0].start + '/' + 'Varış Durağı ve Saati : ' + this.formatDate(item.arrival) + ' - ' + item.destination[0].finish;
    },
...
// CONCATENATED MODULE: ./pages/mytickets.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_myticketsvue_type_script_lang_js_ = (myticketsvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./pages/mytickets.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_myticketsvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var mytickets = __webpack_exports__["default"] = (component.exports);
...
installComponents_default()(component, {VAlert: VAlert["a" /* default */],VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCardText: components_VCard["b" /* VCardText */],VContainer: VContainer["a" /* default */],VDataTable: VDataTable["a" /* default */],VDialog: VDialog["a" /* default */],VIcon: VIcon["a" /* default */],VToolbar: VToolbar["a" /* default */],VToolbarTitle: components_VToolbar["a" /* VToolbarTitle */]})
